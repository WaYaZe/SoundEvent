...
class MAClsTrainer(object):
    ...
    def evaluate(self, resume_model='models/EcapaTdnn_MelSpectrogram_1/best_model/', save_matrix_path=None):
        """
        评估模型
    ...
    def export(self, save_model_path='models/', resume_model='models/EcapaTdnn_MelSpectrogram_1/best_model/'):
        """
        导出预测模型
        :param save_model_path: 模型保存的路径
